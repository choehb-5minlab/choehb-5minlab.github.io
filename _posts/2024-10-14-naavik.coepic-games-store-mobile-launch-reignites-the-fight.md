...
[예를 들어,](https://youtu.be/DAoJ_GkX9HA) [포트나이트를 설치하면 복잡한 "공포 화면"이 나타나기 때문에 마찰은 불행히도 에픽게임즈 스토어 설치에서 끝나지 않습니다. 이 긴 절차를 통과하고 포트나이트를 실행하면, 플레이어가 마침내 로그인하여 플레이하라는 메시지가 표시되기 전에 14GB의 사전 로딩이 진행됩니다.](https://youtu.be/7Kq_gl6q34U)
...
[구글은 당연히 항소했으며](https://blog.google/outreach-initiatives/public-policy/epic-games-verdict-appeal/), 시장 규모 정의가 에픽의 실패한 애플 소송에서 사용된 것과 달라서는 안 되며 경쟁사를 돕는 것을 거부하는 것은 반독점법 위반이 아니라고 주장하고 있습니다. 어떻게 될지 지켜보겠습니다.
...
[*   자체 퍼블리싱 도구
*   에픽을 통한 결제의 경우 12%, 타사 결제의 경우 0%의 스토어 수수료가 부과됩니다.](https://techcrunch.com/2024/05/10/microsoft-is-launching-its-mobile-game-store-in-july/)[에픽 퍼스트 런,](https://store.epicgames.com/features/epic-first-run-program) [Now On Epic](https://store.epicgames.com/features/now-on-epic), [Epic Rewards](https://store.epicgames.com/features/epic-rewards)와 같은 프로그램 ..*   새로운 [무료 게임](https://store.epicgames.com/en-US/free-games) 프로그램.
